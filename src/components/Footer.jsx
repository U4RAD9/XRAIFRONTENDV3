          ...
          <div className="footer_widget">
            ...
            <div className="font-semibold space-y-3 mt-4 text-sm">
              ...
              <div className="mt-6">
                ...
                <div className="flex flex-col space-y-1">
                  <span className="font-bold">Grievance Officer: Mr. Partha Dey</span>
                  <span>Designation: CEO (Founder)</span>
                  <a className="hover:text-gray-300 flex items-center mt-2" href="mailto:parthadey@u4rad.com">
                    <i className="fa fa-envelope mr-2"></i> parthadey@u4rad.com
                  </a>
